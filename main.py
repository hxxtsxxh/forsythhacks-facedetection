...
#path_to_smile = 'haarcascade_smile.xml'
path_to_data = 'haarcascade_frontalface_default.xml'  # trained face data we will use
screen_dimensions = '900x700'
screen_bg_color = "#09066a"
button_bg_color = '#c9d9fa'
button_fg_color = '#3f3fd8'
title_bg_color = '#09066a'
title_fg_color = '#c9d9fa'
